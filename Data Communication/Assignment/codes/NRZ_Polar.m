%Implementation of NRZ-L Polar in MATLAB
...
plot(time,y); %plots graph between time axis and y axis title('NRZ-L Polar'); %sets the title of the plot xlabel('Time'); %sets the label of X axis ylabel('Amplitude'); %sets the label of Y axis
